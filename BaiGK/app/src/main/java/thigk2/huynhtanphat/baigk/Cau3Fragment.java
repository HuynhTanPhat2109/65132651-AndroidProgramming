...
//        recyclerViewLandScape.setLayoutManager(layoutGrid);
    ...
    ArrayList<LandScape> getDataForRecyclerview(){
        ...
        dsDuLieu.add(new LandScape("ponagar", "Bài thuốc 1", "21/09/2005"));
        dsDuLieu.add(new LandScape("eiffel", "Bài thuốc 2", "09/09/2005"));
        dsDuLieu.add(new LandScape("van_ly_truong_thanh", "Bài thuốc 3", "04/12/2024"));
        dsDuLieu.add(new LandScape("buckingham", "Bài thuốc 4", "11/07/2025"));
        dsDuLieu.add(new LandScape("big_ben", "Bài thuốc 5", "09/04/2026"));
        return dsDuLieu;
